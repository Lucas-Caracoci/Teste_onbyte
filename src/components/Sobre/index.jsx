...
const About = () => {
    const diferenciais = [
        ...
        {
          titulo: "Prática do mercado em sala de aula",
    ...
    return (
        <div className=' flex flex-col   items-center justify-around py-20  '>
            ...
            <div className=" w-full  px-10  lg:flex-row flex flex-col  flex-wrap items-center justify-between m-auto h-full   my-20">
            
            {diferenciais.map((item, index) => (
                <div key={index} className='bg-[rgba(255,255,255,0.28)] backdrop-blur-xl backdrop-contrast-150 shadow-[0px_4px_16px_rgba(17,17,26,0.1),_0px_8px_24px_rgba(17,17,26,0.1),_0px_16px_56px_rgba(17,17,26,0.1)] border-red-700 px-2  m-4 min-h-40 flex-[0_0_calc((100%/3)-40px)]  rounded flex flex-col items-center justify-between py-3'>
                    <h4 className='font-bold w-fit  text-blue-950 border-b-2 border-red-700'>{item.titulo}</h4>
                    <p className='text-justify text-blue-950'>{item.descricao}</p>
                </div>
            ))}
